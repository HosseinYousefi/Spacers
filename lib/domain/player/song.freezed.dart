...
class _$SongTearOff {
  ...
  _Song call({required String name, required String artistName}) {
    return _Song(
      name: name,
...
abstract class $SongCopyWith<$Res> {
  ...
  $Res call({String name, String artistName});
}
...
class _$_Song implements _Song {
  const _$_Song({required this.name, required this.artistName});
...
abstract class _Song implements Song {
  const factory _Song({required String name, required String artistName}) =
      _$_Song;
